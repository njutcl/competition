// origin_html=['<div class="box-body-t">',
// '        <div>',
// '            <ul class="menu" id="menu-t">',
// '                <div class="animate" id="animate1"></div>',
// '                <li id="1" class="active" onclick="menu(this)">工商注册</li>',
// '                <li id="2" onclick="menu(this)">知识产权</li>',
// '                <li id="3" onclick="menu(this)">经营许可</li>',
// '                <li id="4" onclick="menu(this)">人事管理</li>',
// '                <li id="5" onclick="menu(this)">投资融资</li>',
// '            </ul>',
// '        </div>',
// '        <div id="submenu">',
// '            <ul id="menu1" class="show">',
// '                <div class="animate" id="animate2"></div>',
// '                <li class="active" id="11" onclick="submenu(this)">注册流程</li>',
// '                <li id="12" onclick="submenu(this)">所需材料</li>',
// '                <li id="13" onclick="submenu(this)">后续事项</li>',
// '                <li id="14" onclick="submenu(this)">公司名称</li>',
// '                <li id="15" onclick="submenu(this)">公司类型</li>',
// '                <li id="16" onclick="submenu(this)">注册资本</li>',
// '                <li id="17" onclick="submenu(this)">注册地址</li>',
// '                <li id="18" onclick="submenu(this)">经营范围</li>',
// '                <li id="19" onclick="submenu(this)">股权分配</li>',
// '                <li id="110" onclick="submenu(this)">购买发票</li>',
// '                <li id="111" onclick="submenu(this)">公司注销</li>',
// '            </ul>',
// '            <ul id="menu2" class="hide">',
// '                <div class="animate" id="animate3"></div>',
// '                <li id="21" class="active" onclick="submenu(this)">产权概念</li>',
// '                <li id="22" onclick="submenu(this)">产权类型</li>',
// '                <li id="23" onclick="submenu(this)">知识产权权益</li>',
// '                <li id="24" onclick="submenu(this)">知识产权出资</li>',
// '                <li id="25" onclick="submenu(this)">工业产权</li>',
// '                <li id="26" onclick="submenu(this)">著作权</li>',
// '            </ul>',
// '            <ul id="menu3" class="hide">',
// '                <div class="animate" id="animate4"></div>',
// '                <li id="31" class="active" onclick="submenu(this)">申请条件</li>',
// '                <li id="32" onclick="submenu(this)">申办材料</li>',
// '                <li id="33" onclick="submenu(this)">核准</li>',
// '            </ul>',
// '            <ul id="menu4" class="hide">',
// '                <div class="animate" id="animate5"></div>',
// '                <li id="41" class="active" onclick="submenu(this)">录用</li>',
// '                <li id="42" onclick="submenu(this)">调配</li>',
// '                <li id="43" onclick="submenu(this)">任免</li>',
// '                <li id="44" onclick="submenu(this)">考核</li>',
// '            </ul>',
// '            <ul id="menu5" class="hide">',
// '                <div class="animate" id="animate6"></div>',
// '                <li id="51" class="active" onclick="submenu(this)">企业融资</li>',
// '                <li id="52" onclick="submenu(this)">企业投资</li>',
// '                <li id="53" onclick="submenu(this)">申请方式</li>',
// '                <li id="54" onclick="submenu(this)">办理流程</li>',
// '                <li id="55" onclick="submenu(this)">投融资电子商务化</li>',
// '            </ul>',
// '        </div>',
// '        <div id="content">',
// '            <div id="content1">',
// '                <div class="article-active" id="1111">',
// '                    <div class="process">',
// '                        <h4> 第一步 核准名称</h4>',
// '                        <p> 时间：1-3个工作日</p>',
// '                        <p> 操作：确定公司类型、名字、注册资本、股东及出资比例后，可以去工商局现场或线上提交核名申请。</p>',
// '                        <p> 结果：核名通过，失败则需重新核名。',
// '                        </p>',
// '                    </div>',
// '                    <div class="process">',
// '                        <h4> 第二步 提交资料</h4>',
// '                        <p> 时间：5-15个工作日',
// '                            <p> 操作：核名通过后，确认地址信息、高管信息、经营范围，在线提交预申请。在线预审通过之后，按照预约时间去工商局递交申请材料。</p>',
// '                            <p> 结果：收到准予设立登记通知书。</p>',
// '                    </div>',
// '                    <div class="process">',
// '                        <h4> 第三步 领取执照</h4>',
// '                        <p> 时间：预约当天',
// '                            <p> 操作：携带准予设立登记通知书、办理人身份证原件，到工商局领取营业执照正、副本。</p>',
// '                            <p> 结果：领取营业执照。</p>',
// '                    </div>',
// '                    <div class="process">',
// '                        <h4> 第四步 刻章等事项</h4>',
// '                        <p> 时间：1-2个工作日</p>',
// '                        <p> 操作：凭营业执照，到公安局指定刻章点办理：公司公章、财务章、合同章、法人代表章、发票章；至此，一个公司注册完成。</p>',
// '                    </div>',
// '                </div>',
// '                <div class="article-hide" id="1112">',
// '                    <p> 1、公司法定代表人签署的《公司设立登记申请书》；',
// '                        2、全体股东签署的公司章程；',
...
// '                </div>',
// '                <div class="article-hide" id="1113">',
// '                    <p>',
// '                        1、办理银行基本户',
...
// '                        工商行政规定，未按规定期限公示年度报告的企业，工商机关会将其载入经营异常名录，并处罚款。超过三年未年报的企业，将会纳入严重违法企业“黑名单”。纳入异常名录后，',
// '                        企业将无法变更、注销、转股，对外合作时，社会公众可随时查看到该公司的异常情况。同时对法人、高管进行行政限制。"',
// '                </div>',
// '                <div class="article-hide" id="1114">',
// '                    <p>',
...
// '                </div>',
// '                <div class="article-hide" id="1115">',
// '                    <p>',
// '                        有限责任公司',
...
// '                        (3)目前成熟的天使、VC，几乎都基于“有限责任公司”设计投资方案。直接注册“有限责任公司”，在未来引进投资过程中也会比较顺利 [2] 。',
// '                        股份有限公司',
...
// '                </div>',
// '                <div class="article-hide" id="1116">',
// '                    <p>',
// '                        注册资本是全体股东出于公司经营需要，提供或承诺提供给公司的资金总数。',
// '                        需要注意的是，大部分的公司叫“XX有限公司”或“XX有限责任公司”。这里的有限责任公司的股东对公司的债务只承担有限的责任，而承担的最高额度就是公司的注册资本。',
// '                        1、注册资本并不需要一次缴清',
// '                        我国目前实行注册资本认缴制，认缴制的意思就是：注册资本不用在一开始就全部缴纳完成，而是只要在承诺的时限内(一般为10-20年)缴完即可，这极大的降低了公司注册时的资金压力。 [1]',
...
// '                </div>',
// '                <div class="article-hide" id="1117">',
// '                    <p>',
...
// '                </div>',
// '                <div class="article-hide" id="1118">',
// '                    <p>',
...
// '                </div>',
// '                <div class="article-hide" id="1119">',
// '                    <p>',
...
// '                        4、创始合伙人的得权期、退出机制、回购权一个完整的企业股权结构，除了合理的股份分配外，还要有科学的管理体系，即提前约定好股权的得权、退出和回购机制，避免日后纠纷。',
// '                        5、提前留一定的期权池',
// '                        互联网公司股权激励的作用越来越重要，初创阶段股权分配时有必要提前预留一定的期权池，为今后的股权激励留出余地，一般期权池的比例大多设置为10%到20%，这些股份通常由创始人代持。',
// '                </div>',
// '                <div class="article-hide" id="11110">',
// '                    <p>',
// '                        发票购用簿及发票申请报批准表。',
// '                        办税人员(一般为财务人员或企业法人、职员等)的身份证、证件照2张、办理发票准购证。',
// '                        带好公章、法人章、发票专用章、税务登记证（三证合一、五证合一后企业需要携带营业执照正副本原件。）。办税人员本人和公司财务负责人员同去税务部门，第一次领发票需法人签字、即需要法人同去税务部门。',
// '                        备注：以上材料为纳税人第一次购票应准备手续，一般纳税人第一次购票，除做以上准备外，还应准备以下材料：电脑培训的上岗证原件，税控系统IC卡，购票前先自己电脑零抄税一次（在抄税前，应先输入企业的基本信息），并打印零抄税单。如税务部门有新要求或新规定企业应以税务部门为准！',
...
// '                        征收方式各市各行政区税务机关掌握不同，大多税务所都采用查账征收方式。鉴于实际经营当中多数企业没有进货发票以致造成账面利润过高，所以推荐小公司采用核定征收在税负上比较划算。落户经济开发区企业可享受地方财政扶持（税收奖励）另外全国各个地方的具体行政收费不同，以当地行政部门要求为准。"',
// '                </div>',
// '                <div class="article-hide" id="11111">',
// '                    <p>',
// '                        当公司不打算经营时，要及时进行注销。如果放着不管，几个月后税务机关就会把公司吊销，吊销不仅会使公司本身，而且连同其法定代表人均会进入企业信用黑名单，影响法人的信贷、开办公司、出入境等。',
// '                        如果不幸被工商部门吊销营业执照了，也需要先把吊销转成正常的公司注销流程，且不能恢复经营。"',
// '                </div>',
// '            </div>',
// '            <div id="content2">',
// '                <div class="article-active" id="1121">',
// '                    <p>知识产权是指人们就其智力劳动成果所依法享有的专有权利，通常是国家赋予创造者对其智力成果在一定时期内享有的专有权或独占权（exclusive right）。',
...
// '                </div>',
// '                <div class="article-hide" id="1122">',
// '                    <p>',
// '                        （一）著作权',
...
// '                </div>',
// '                <div class="article-hide" id="1123">',
// '                    <p>',
// '                        （一）人身权利',
...
// '                </div>',
// '                <div class="article-hide" id="1124">',
// '                    <p>',
// '                        商标权',
...
// '                </div>',
// '                <div class="article-hide" id="1125">',
// '                      <p> 自然科学、社会科学以及文学、音乐、戏剧、绘画、雕塑、摄影和电影摄影等方面的作品组成版权。版权是法律上规定的某一单位或个人对某项著作享有印刷出版和销售的权利，任何人要复制、翻译、改编或演出等均需要得到版权所有人的许可，否则就是对他人权利的侵权行为。知识产权的实质是把人类的智力成果作为财产来看待。著作权是文学、艺术、科学技术作品的原创作者，依法对其作品所享有的一种民事权利。',
...
// '                </div>',
// '                <div class="article-hide" id="1126">',
// '                      <p> 主要内容',
// '                    1、著作权自作品创作完成之日起产生。',
// '                    2、又叫版权。分为著作人格权与著作财产权。其中著作人格权的内涵包括了公开发表权、姓名表示权及禁止他人以扭曲、变更方式利用著作损害著作人名誉的权利。',
// '                    3、有以下几条权利：发表权，署名权，修改权，保护作品完整权，复制权，发行权，出租权，展览权，表演权，放映权，广播权，信息互联网传播权，摄制权，改编权，翻译权，汇编权，应当由著作权人享有的其他权利。</div>',
// '            </div>',
// '            <div id="content3">',
// '                <div class="article-active" id="1131">',
// '                    <p>申请网站ICP许可证的，应当符合《中华人民共和国电信条例》第十三条的规定和下列条件：',
...
// '                        7、国家规定的其他条件。',
// '                </div>',
// '                <div class="article-hide" id="1132">',
// '                    <p>',
...
// '                </div>',
// '                <div class="article-hide" id="1133">',
// '                    <p>',
// '                        1、申办材料齐全、规范、有效。',
...
// '            </div>',
// '            <div id="content4">',
// '                <div class="article-active" id="1141">',
// '                    <p>',
...
// '                </div>',
// '                <div class="article-hide" id="1142">',
// '                    <p>',
...
// '            </div>',
// '            <div id="content5">',
// '                <div class="article-active" id="1151">',
// '                    <p>企业融资主要有两种形式：',
// '                        一种是内源融资：',
...
// '                </div>',
// '                <div class="article-hide" id="1152">',
// '                    <p>',
...
// '                </div>',
// '                <div class="article-hide" id="1153">',
// '                    <p>1.投融资行为的介入程度：直接投资，间接投资。',
// '                        　　',
...
// '                </div>',
// '                <div class="article-hide" id="1154">',
// '                    <p>',
...
// '                        5.投融资办理完成。</p>',
// '                </div>',
// '                <div class="article-hide" id="1155">',
// '                    <p>',
...
function toToolsFromNav(){
    ...
    // $(".box-content-full").html(origin_html);
